...
namespace WindowsFormsApplication1
{
    public partial class Form28 : Form
    {
        ...
        private void Form28_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            string sqe = "SELECT Roll_No,Name,Father_Name,Class,Gender,Phone,DOB,CNIC,Nationality,Religion,Address From Student12";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ///// to shoewe data in d_grrd
            con.Open();
            string sqe = "SELECT Roll_No,Name,Father_Name,Class,Gender,Phone,DOB,CNIC,Nationality,Religion,Address From Student12 AND Batch = '" + textBox1.Text + "'";
            sda = new SqlDataAdapter(sqe, con);
            dt = new DataTable();
