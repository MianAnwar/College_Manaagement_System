...
namespace WindowsFormsApplication1
{
    public partial class Form51 : Form
    {
        ...
        private void Form51_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            string sqe = "SELECT Roll_No,St_Name,Class From AttendenceE";
            sda = new SqlDataAdapter(sqe, con);
            ds = new DataSet();

            sda.Fill(ds, "AttendenceE");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                ///// to shoewe data in d_grrd
                string sqe = "SELECT Roll_No,St_Name,Class," + s + " From AttendenceE";
                sda = new SqlDataAdapter(sqe, con);
                ds = new DataSet();
            ...
            {
                ///// to shoewe data in d_grrd
                string sqe = "SELECT Roll_No,St_Name,Class," + s + " From AttendenceE where Batch = '" + textBox1.Text + "'";
                sda = new SqlDataAdapter(sqe, con);
                ds = new DataSet();
