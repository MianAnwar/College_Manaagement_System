...
namespace WindowsFormsApplication1
{
    public partial class Form23 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                ///// to shoewe data in d_grrd
                string sqe = "SELECT Roll_No,St_Name,Class," + s + " From Attendence11";
                sda = new SqlDataAdapter(sqe, con);
                ds = new DataSet();

                sda.Fill(ds, "Attendence11");
                dataGridView1.DataSource = ds.Tables[0];
            }
            else
            {
                ///// to shoewe data in d_grrd
                string sqe = "SELECT Roll_No,St_Name,Class," + s + " From Attendence11 where Batch = '" + textBox1.Text + "'";
                sda = new SqlDataAdapter(sqe, con);
                ds = new DataSet();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            ///// to shoewe data in d_grrd
            con.Open();
            string sqe = "SELECT Roll_No,St_Name,Class From Attendence11";
            sda = new SqlDataAdapter(sqe, con);
            ds = new DataSet();
