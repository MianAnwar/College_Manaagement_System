...
namespace WindowsFormsApplication1
{
    public partial class Form13 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string sqe = "SELECT Id,T_Name From TeacherAttendence";
            sda = new SqlDataAdapter(sqe, con);
            ds = new DataSet();

            sda.Fill(ds, "TeacherAttendence");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                ///// to shoewe data in d_grrd
                string sqe = "SELECT Id,T_Name," + s + " From TeacherAttendence";
                sda = new SqlDataAdapter(sqe, con);
                ds = new DataSet();
            ...
            {
                ///// to shoewe data in d_grrd
                string sqe = "SELECT Id,T_Name," + s + " From TeacherAttendence where Batch = '" + textBox1.Text + "'";
                sda = new SqlDataAdapter(sqe, con);
                ds = new DataSet();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            //sda.Update(ds, "TeacherAttendence");
