...
namespace WindowsFormsApplication1
{
    public partial class Form21 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string sqe = "SELECT Roll_No,St_Name,Class From Attendence9";
            sda = new SqlDataAdapter(sqe, con);
            ds = new DataSet();

            sda.Fill(ds, "Attendence9");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                ///// to shoewe data in d_grrd
                string sqe = "SELECT Roll_No,St_Name,Class," + s + " From Attendence9";
                sda = new SqlDataAdapter(sqe, con);
                ds = new DataSet();
            ...
            {
                ///// to shoewe data in d_grrd
                string sqe = "SELECT Roll_No,St_Name,Class," + s + " From Attendence9 where Batch = '" + textBox1.Text +"'";
                sda = new SqlDataAdapter(sqe, con);
                ds = new DataSet();
