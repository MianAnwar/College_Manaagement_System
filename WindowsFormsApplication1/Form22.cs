...
namespace WindowsFormsApplication1
{
    public partial class Form22 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                ///// to shoewe data in d_grrd
                string sqe = "SELECT Roll_No,St_Name,Class," + s + " From Attendence10";
                sda = new SqlDataAdapter(sqe, con);
                ds = new DataSet();

                sda.Fill(ds, "Attendence10");
                dataGridView1.DataSource = ds.Tables[0];
            }
            else
            {
                ///// to shoewe data in d_grrd
                string sqe = "SELECT Roll_No,St_Name,Class," + s + " From Attendence10 where Batch = '" + textBox1.Text +"'";
                sda = new SqlDataAdapter(sqe, con);
                ds = new DataSet();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            ///// to shoewe data in d_grrd
            con.Open();
            string sqe = "SELECT Roll_No,St_Name,Class From Attendence10";
            sda = new SqlDataAdapter(sqe, con);
            ds = new DataSet();
