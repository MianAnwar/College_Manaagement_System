...
namespace WindowsFormsApplication1
{
    public partial class Form44 : Form
    {
        ...
        private void Form44_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            string sqe = "SELECT Roll_No,Name,Father_Name,Class,Gender,Phone,DOB,CNIC,Nationality,Religion,Address From Studentother";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ///// to shoewe data in d_grrd
            con.Open();
            string sqe = "SELECT Roll_No,Name,Father_Name,Class,Gender,Phone,DOB,CNIC,Nationality,Religion,Address From Studentother where Batch = '" + textBox1.Text + "'";
            sda = new SqlDataAdapter(sqe, con);
            dt = new DataTable();
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            rtReceipt = "\n                            College College    \n";
            rtReceipt = rtReceipt + "---------------------------------------------------------------------------------\n";
            rtReceipt = rtReceipt + "            CLASS: Junior \n";
